...
export class Newsitem extends Component {
  articles = [
    ...
    },
    {
      ...
      title:
        "Dow Jones Futures Rise After Stocks Shrug Off Powell; Super Micro Flashes Buy Signal - Investor's Business Daily",
      description:
        'The Fed chief cited a "lack of further progress" on inflation.',
      url: "https://www.investors.com/market-trend/stock-market-today/dow-jones-futures-fed-chief-powell-super-micro-asml-earnings/",
      urlToImage:
        "https://www.investors.com/wp-content/uploads/2024/04/SMTpowell041624news.jpg",
      publishedAt: "2024-04-17T02:40:00Z",
      content:
        "Dow Jones futures rose slightly overnight, along with S&amp;P 500 futures and Nasdaq futures. Chip-equipment giant ASML (ASML) reports before Wednesday's open.\r\nXThe ailing stock market rally had a r… [+8055 chars]",
    },
    {
    ...
    },
    {
      ...
      author: "Reuters",
      title:
        "Father of alleged Sydney church attacker saw no signs of radicalism, community leader says - Reuters",
      description: null,
      url: "https://www.reuters.com/world/asia-pacific/father-sydney-church-attacker-says-no-signs-radicalism-community-leader-says-2024-04-17/",
      urlToImage: null,
      publishedAt: "2024-04-17T01:11:56Z",
      content: null,
    },
    {
      ...
      title:
        "NASA's Ingenuity Mars Helicopter Team Says Goodbye … for Now - NASA Jet Propulsion Laboratory",
      description:
      ...
      url: "https://www.jpl.nasa.gov/news/nasas-ingenuity-mars-helicopter-team-says-goodbye-for-now",
      urlToImage:
        "https://d2pn8kiwq2w21t.cloudfront.net/original_images/1_-_PIA26238_heli_on_valinor.png",
      publishedAt: "2024-04-17T01:04:14Z",
      content:
        "Decades of Room\r\nIf a critical electrical component on Ingenuity were to fail in the future, causing data collection to stop, or if the helicopter eventually loses power because of dust accumulation … [+1540 chars]",
    },
    {
    ...
    },
    {
      ...
      author: "Axios",
      title:
        "Romney open to voting with Democrats to dismiss Mayorkas impeachment - Axios",
      description: null,
      url: "https://www.axios.com/2024/04/16/mayorkas-impeachment-dismiss-vote-mitt-romney",
      urlToImage: null,
      publishedAt: "2024-04-17T00:22:06Z",
      content: null,
    },
    {
  ...
  render() {
    let { tittle, description, imgUrl } = this.props;
    return (
      <div className="my-3">
